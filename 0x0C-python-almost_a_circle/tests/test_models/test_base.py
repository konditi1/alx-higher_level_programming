...
class TestBase(unittest.TestCase):
    ...
    def test_mixed_id_assignment(self):
        """
        Test the id assignment when a mixture of custom
        and default ids are used.
        """
        b7 = Base()
        b8 = Base(50)
        b9 = Base()
    ...
    def test_id_increment_after_custom_id(self):
        """
        Test that the id counter increments correctly even
        after a custom id is assigned.
        """
        b10 = Base(100)
        b11 = Base()
