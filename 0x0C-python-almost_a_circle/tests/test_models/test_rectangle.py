...
class TestRectangle(unittest.TestCase):
    ...
    def test_one_arg(self):
        """
        Test creating a Rectangle instance with only
    ...
    def test_more_than_five_args(self):
        """
        Test creating a Rectangle instance with more than
        five arguments raises TypeError.
        """
        with self.assertRaises(TypeError):
    ...
    def test_args(self):
        """
        Test creating a Rectangle instance with
        arbitrary number of width arguments.
        """
    ...
    def test_args_and_kwargs(self):
        """
        Test creating a Rectangle instance with a combination of
    ...
    def test_empty_args_and_kwargs(self):
        """
        Test creating a Rectangle instance with no
        arguments and no keyword arguments.
        """
        with self.assertRaises(TypeError):
            Rectangle(*(), **{})
